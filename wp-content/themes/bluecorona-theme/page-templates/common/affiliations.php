        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 m-auto text-center">
                    <h3 class="text-center mb-5 mt-5 bc_alternate_font_blue">Affiliations</h3>
                    <div class="swiper-container bc_affiliation_swiper container mb-5">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class='text-center'><a href=""><img class="img-fluid bc_affliations_img" alt="eslogo" src="<?php echo get_template_directory_uri();?>/img/es_logo.png"></a></div>
                            </div>
                            <div class="swiper-slide">
                                <div class='text-center'><a href=""><img class="img-fluid bc_affliations_img" alt="brlogo" src="<?php echo get_template_directory_uri();?>/img/br_logo.png"></a></div>
                            </div>
                            <div class="swiper-slide">
                                <div class='text-center'><a href=""><img class="img-fluid bc_affliations_img" alt="allogo" src="<?php echo get_template_directory_uri();?>/img/al_logo.png"></a></div>
                            </div>
                            <div class="swiper-slide">
                                <div class='text-center'><a href=""><img class="img-fluid bc_affliations_img" alt="bbblogo" src="<?php echo get_template_directory_uri();?>/img/bbb_logo.png"></a></div>
                            </div>
