        ...
        <div class="container p-4">
            <div class="row ">
                <h1 class="bc_alternate_font_blue m-auto py-5">
                    ...
                    <button class="btn bc_default_primary pl-4 pr-4 pt-2 pb-2 mr-2 mb-2 text-white bc_branding_btn_1">
                    <span class="">Apply Today <i aria-hidden="true" class="fa fa-chevron-circle-right"></i>
                    </span></button>
                </h1>
            </div>
        </div>
        ...
        <div class="container pt-5 pb-5 m-auto">
            ...
            <div class="col-md-12 mt-4">
                <div class="row text-center">
                    <span class="m-auto">
                    <button class="btn bc_hero_btn_bg_color pl-4 pr-4 pt-2 pb-2 mr-2 mb-2 text-white bc_branding_btn_1">
                        <span class="">
                         Schedule Service <i aria-hidden="true" class="fa fa-chevron-circle-right"></i>
                        </span>
                    </button>
                    <span class="bc_alternate_font_blue" style="font-size: 36px; color: #686868">or</span>
                    <button class="btn btn-primary pl-4 pr-4 pt-2 pb-2  mr-2 mb-2 bc_branding_btn_2">
                        Call: <strong>(555) 555-5555</strong>
                    </button>
                    </span>
                </div>
            </div>
