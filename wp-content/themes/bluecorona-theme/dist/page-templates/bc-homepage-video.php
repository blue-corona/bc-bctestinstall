...
get_header();?>
  ...
  <main role="main">
    ...
    <div class="container-fluid p-0 bc_hero_container bc_home_section_bg">
        <iframe width="100%" height="540" class="position-absolute" src="https://www.youtube.com/embed/Wjrrgrvq1ew?controls=0&autoplay=1&loop=1&rel=0&playlist=668nUCeBHyY"  frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="container px-4 pt-4">
            <div class="row text-center text-lg-left text-md-left">
                <div class="col-md-6 col-xs-12 col-lg-6 col-sm-12 m-auto">
                    <h1 class="text-white">Have an 
                        <span class="bc_alternate_font_blue">Emergency</span><em>?</em>
                    </h1>
                    <h1 class="text-white">We're Here for 
                        <span class="bc_alternate_font_blue">You</span> 24/7 <em>!</em>
                    </h1>
                    <button class="btn text-white bc_default_primary py-2 mt-2"> Schedule Service Today &nbsp;<i aria-hidden="true" class="fa fa-chevron-circle-right"></i></button>
                </div>
                <div class="col-md-6 col-xs-12 col-lg-6 col-sm-12 p-4">
                    <div class=" col-md-12 col-lg-9 col-sm-12 col-xs-12 offset-lg-2">
                        <div class="bc_hero_form_title d-flex py-3 px-4">
                            ...
                            <h2 class="bc_alternate_font_white text-center px-2 pt-1">
                                Emergency Service
                            </h2>
                        </div>
