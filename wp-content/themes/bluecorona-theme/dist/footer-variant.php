<footer class="page-footer font-small blue">
    ...
    <div class="container-fluid bc_default_primary text-md-left pl-0 pt-5">
        <img alt="footer man" height="323px" class="position-absolute d-none d-lg-block " src="<?php echo get_site_url();?>/wp-content/themes/blue-corona-theme/img/footer_eng.png">
        <div class="container py-4">
            <div class="row">
                <div class="col-lg-12 offset-0  col-md-12">
                    <div class="row">
                        <div class="col-md-3 m-auto text-center px-5 px-md-0 text-white">
                            <img alt="footer logo" src="<?php echo get_site_url();?>/wp-content/themes/blue-corona-theme/img/footerlogo.png">
                            <hr style="background-color:#5692b9;">
                            <div class="bc_social_media py-2" style="color: #5692b9;">
    ...
    <div class="bc_footer_copyright_bar text-center text-lg-left py-2 container nunito">
       ...
       <a class="bc_footer_copyright_links no_hover_underline  d-block d-lg-inline d-md-inline" href="#"><img src="<?php echo get_site_url();?>/wp-content/themes/blue-corona-theme/img/bc_logo.png">&nbsp;Blue Corona</a>
